...
def test_add_user_success(mock_get_lat_lon_from_postcode, mock_user_data, mock_users_service):
    name = "test_user"
    postcode = "EH1 1AA"
...
@patch('src.users.api.UserData')
@patch('src.users.api.get_lat_lon_from_postcode')
def test_add_user_get_lat_lon_failure(mock_get_lat_lon_from_postcode, mock_user_data, mock_users_service):
    name = "test_user"
    postcode = "INVALID"
...
@patch('src.users.api.UserData')
@patch('src.users.api.get_lat_lon_from_postcode')
def test_add_user_check_location_failure(mock_get_lat_lon_from_postcode, mock_user_data, mock_users_service):
    name = "test_user"
    postcode = "EH1 1AA"
    mock_latlon = LatLon(lat=55.9533, lon=-3.1883)
    mock_get_lat_lon_from_postcode.return_value = mock_latlon
